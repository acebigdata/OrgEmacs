...
DATA_DIR_OUT = join(dirname(__file__), 'tmp')
...
year_list = ['FY1998', 'FY1999', 'FY2000', 'FY2001', 'FY2002', 'FY2003', 'FY2004',
 'FY2005', 'FY2006', 'FY2007', 'FY2008', 'FY2009', 'FY2010', 'FY2011', 'FY2012',
 'FY2013', 'FY2014', 'FY2015', 'FY2016', 'IQ_LTM']
...
def load_selection():
    ...
    df_groupbyyear_min = select_data_1.min()
    df_groupbyyear_mean = select_data_1.mean()
    df_groupbyyear_max = select_data_1.max()
    df_groupbyyear_median = select_data_1.median()
    df_groupbyyear_bottom_20 = select_data_1.quantile(0.2)
    df_groupbyyear_top_20 = select_data_1.quantile(0.8)

    source_stat.data = {
        'min': [df_groupbyyear_min[select_metric]],
        'max': [df_groupbyyear_max[select_metric]],
        'mean': [df_groupbyyear_mean[select_metric]],
        'median': [df_groupbyyear_median[select_metric]],
        'top_20': [df_groupbyyear_top_20[select_metric]],
        'bottom_20': [df_groupbyyear_bottom_20[select_metric]],
    }
...
main_display = column(stat_table, data_table)
