#+setupfile: ~/Dropbox/OrgEmacs/themes/theme-bigblow.setup
#+OPTIONS: num:nil whn:2 toc:4 H:6
...
*** Anaconda Remove
**** conda istall anaconda-clean   # install the package anaconda clean
...
*** AVA On Board
**** Goals: Major Update in 11 days <2017-06-23 Fri>
...
**** Optimization Applets: Lindo + PulP
***** [[https://pythonhosted.org/PuLP/][Pulp]]
**** Purchasing Analytics
***** [[http://www.tendereasy.com/en-GB/story-33907212][TenderEasy]]
*** TODO Tasks
**** Finish all AVA apps <2017-06-12 Mon>
***** ROIC
***** Data table download
***** Idea Generation
***** Data validation
**** Steel optimization <2017-06-14 Wed>
***** Results validation
***** Basic UI
